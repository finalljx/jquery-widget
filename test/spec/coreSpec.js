define( ['dist/jquery-widget'], function( $ ) {

    describe( 'widget factory', function () {

        it( 'widget creation', function() {
            var testWidget = $.widget( 'testWidget', {
                _create: function() {
                    return '_create';
                },
            ...
            expect(testWidget.prototype.option).toBe($.Widget.prototype.option);
        } );
        ...
        xit( 'inheritance', function() {
            ...
            var testWidgetBase = $.widget( 'testWidgetBase', {
                options: {
                    obj: {
                        key1: 'foo',
                        key2: 'bar'
            ...
            var testWidgetExtension = $.widget( 'testWidgetExtension', testWidgetBase, {
                options: {
                    obj: {
                        key1: 'baz'
                    },
        ...
        it( '._super()', function() {
            ...
            var testWidget2 = $.widget( 'testWidget2', testWidget, {
                method: function( a, b ) {
                    expect(this).toBe(instance);
                    expect(a).toBe(5);
                    expect(b).toBe(10);
            ...
            var testWidget3 = $.widget( 'testWidget3', testWidget2, {
                method: function( a ) {
                    expect(this).toBe(instance);
                    expect(a).toBe(5);
        ...
        it( 'mixins', function() {
            ...
            var testWidget = $.widget( 'testWidget', [ mixin1, mixin2, prototype ] );
        ...
        it( 'mixins with inheritance', function() {
            ...
            var testWidget = $.widget('testWidget', [mixin1, parentPrototype]);
            var testWidget2 = $.widget('testWidget2', testWidget, [mixin2, childPrototype]);
        ...
        xdescribe('destroy', function() {
            ...
            beforeEach(function () {
                ...
                this.testWidget = $.widget('testWidget', {
                    _create: function() { },
                    destroy: function() {
                        destroy();
                    },
